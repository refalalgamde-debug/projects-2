...
function findWasmBinary() {
  return locateFile('calories.wasm');
}
...
var _calculate_calories = Module['_calculate_calories'] = makeInvalidEarlyAccess('_calculate_calories');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['calculate_calories'] != 'undefined', 'missing Wasm export: calculate_calories');
  ...
  _calculate_calories = Module['_calculate_calories'] = createExportWrapper('calculate_calories', 5);
...
if (typeof exports === 'object' && typeof module === 'object') {
  ...
  module.exports.default = CalculatorModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => CalculatorModule);
